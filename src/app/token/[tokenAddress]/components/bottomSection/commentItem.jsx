  ...
  return (
    <div className=' w-full rounded-3xl relative bg-blackPry overflow-hidden p-3'>
        ...
        <div className=' w-full flex justify-end items-center'>
            <p className={`${mont.className} font-extrabold bg-gradient-to-r from-bluePry to-[#5E6EFF] bg-clip-text text-transparent`}>{timeAgo(data.time)}</p>
        </div>

        <p className={` w-full text-white ${mont.className} font-extrabold`}>{data.comment}</p>
    </div>
  )
}
